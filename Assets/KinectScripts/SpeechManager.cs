...
public class SpeechManager : MonoBehaviour 
{
	...
	void StartRecognizer() 
	{
		...
		{
			if(debugText != null)
				debugText.guiText.text = "Por favor, espere...";
			...
			if(debugText != null)
				debugText.guiText.text = "Listo.";
		} 
		catch(DllNotFoundException ex)
		{
			Debug.LogError(ex.ToString());
			if(debugText != null)
				debugText.guiText.text = "Por favor verifique que las instalaciones del Kinect y el SAPI.";
		}
		catch (Exception ex) 
		{
			Debug.LogError(ex.ToString());
		...
		if(sapiInitialized)
		{
			if(debugText != null)
			{
				if(isPhraseRecognized)
					...
					debugText.guiText.text = "Escuchando...";
			}
		}
	}
